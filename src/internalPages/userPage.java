...
public class userPage extends javax.swing.JInternalFrame {
    ...
    private void editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editMouseClicked
        ...
        userForm uf = new userForm ();
        uf.user_id.setText(""+model.getValueAt(rowindex,0));
        uf.fname.setText(""+model.getValueAt(rowindex,1));
        uf.lname.setText(""+model.getValueAt(rowindex,2));
        uf.email.setText(""+model.getValueAt(rowindex,3));
        uf.username.setText(model.getValueAt(rowindex,4).toString());
        uf.password.setText(model.getValueAt(rowindex,5).toString());
        uf.setVisible(true);
        uf.action = "UPDATE";
        uf.u_label.setText("UPDATE");
        JFrame mainFrame = (JFrame) SwingUtilities.getWindowAncestor(this);
        mainFrame.dispose();
        }
