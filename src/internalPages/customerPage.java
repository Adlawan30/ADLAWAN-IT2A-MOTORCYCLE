...
public class customerPage extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IconsFolder/rating.png"))); // NOI18N
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 0, 60, 80));
    ...
    private void editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editMouseClicked
        ...
        customerForm cf = new customerForm ();
        cf.c_id.setText(""+model.getValueAt(rowindex,0));
        cf.c_fname.setText(""+model.getValueAt(rowindex,1));
        cf.c_lname.setText(""+model.getValueAt(rowindex,2));
        ...
        cf.c_status.setSelectedItem(model.getValueAt(rowindex,5).toString());
        cf.c_address.setText(model.getValueAt(rowindex,4).toString());
        cf.c_contact.setText(model.getValueAt(rowindex,6).toString());
        cf.c_email.setText(model.getValueAt(rowindex,7).toString());
        cf.setVisible(true);
        cf.action = "UPDATE";
        cf.c_label.setText("UPDATE");
        JFrame mainFrame = (JFrame) SwingUtilities.getWindowAncestor(this);
        mainFrame.dispose();
        }
